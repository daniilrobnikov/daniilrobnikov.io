    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flow-root lg:mt-10">
          <div className="-mt-4 -ml-8 flex flex-wrap justify-between text-gray-400 lg:-ml-4">
            <div className="relative mt-4 ml-8 flex h-12 flex-shrink-0 flex-grow lg:ml-4">
              <Image
            ...
            <div className="relative mt-4 ml-8 flex h-12 flex-shrink-0 items-center justify-center lg:ml-4">
              <svg
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="h-8 w-8 flex-none stroke-current"
                stroke-width="1.5"
